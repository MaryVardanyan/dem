...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 19 2024 г., 21:48
...
(1, 2, 1, 1, 4, NULL, '', '2024-12-29', '01:31:00', '+7(999)-999-99-99', 'Заявка'),
(2, 1, 2, 1, 2, 'Плохая заявка', 'Описание', '2024-12-15', '23:35:00', '+7(999)-999-99-99', 'Просто заявка'),
(3, 2, 2, 3, 1, NULL, '', '2024-12-01', '21:04:00', '+7(999)-999-99-99', 'Просто заявка');
